...
## Purpose
Save and restore node graph state including node positions, properties, types, and visualizations to/from JSON files, with auto-load of default project at startup.
