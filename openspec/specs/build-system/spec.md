...
. **THEN** the imgui_shell_desktop target SHALL have WIN32_EXECUTABLE property set based on CMAKE_BUILD_TYPE`n. **AND** Release builds SHALL have WIN32_EXECUTABLE=TRUE`n. **AND** Debug builds SHALL have WIN32_EXECUTABLE=FALSE (or unset)

#### Scenario: Visual Studio project reflects correct subsystem
1. **WHEN** Visual Studio opens the generated Windows project
