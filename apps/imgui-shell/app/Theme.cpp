...
// Runtime typography state. Initialized to the constexpr defaults; mutated
// by setThemeFontFile / setThemeFontSizePx (called by ThemeStorage when a
